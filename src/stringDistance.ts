/**
 * Calculates the Damerau-Levenshtein distance between two strings. https://gist.github.com/IceCreamYou/8396172
 */
export function distance(source:string, target:string) {
